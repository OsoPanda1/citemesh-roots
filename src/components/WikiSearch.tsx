...
const searchIndex = [
  ...
  { title: "Introducción", url: "/introduccion", keywords: "qué es tamv origen historia ecosistema civilizatorio" },
  ...
  { title: "Economía TAMV", url: "/dominios/economia", keywords: "tau token intercambio valor ético trazabilidad blockchain" },
